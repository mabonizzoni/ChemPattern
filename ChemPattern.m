...
(* Remember that from now on dataset[[1,1]] contains no interesting data *)
...
(* ALL comparisons should be done with SameQ rather than Equal to guarantee evaluation even with unassigned symbols *)
...
If[VectorQ[dataset[[1,2;;]],NumberQ]==True,
PrependTo[dataset,Join[{""},labels=ToString/@Array["var",Last@Dimensions@dataset-1]]]
];

(* pick out variable names (vars) and data labels (labels) *)
vars=dataset[[1,2;;]];
labels=dataset[[2;;,1]];
