...
(* ::Subsection:: *)
(*The automated version (became standard in Dec 2018; used to be called outlierPCAauto)*)
...
(* ::Input::Initialization:: *)
Options[outlierPCA]={output->"Plots"};

outlierPCA[dataset_List?(MatrixQ[#[[2;;,2;;]],NumberQ]&),OptionsPattern[]]:=Module[{results},
results=Association@
KeyValueMap[
...
_,(*option value not recognized*)Message[outlierPCA::usage]
]
]

(*Default definition to bring up a syntax error for incorrect usage*)
outlierPCA[__]:=Message[outlierPCA::usage]
